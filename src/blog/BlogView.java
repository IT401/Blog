...
public class BlogView extends View {
    ...
    private ArrayList<BlogPanel> messagePanels = new ArrayList<BlogPanel>();
    ...
    public void setBlogPanels(ArrayList<BlogPanel> messagePanels) {
      this.messagePanels = messagePanels;
      for (int i = 0; i < messagePanels.size(); i++) {
        c.gridy = i;
        contentPane.add(messagePanels.get(i), c);
      }
    }
}
